...
from app.utils.rendered_query import Window, Viewport, ThreeVec, Orientation, RenderingMethod, get_query_viewport, \
     get_query_window, accept_headers_rendered, get_query_3vec


wado_renderedmpr_router = APIRouter()
...
@wado_renderedmpr_router.get("/studies/{study_uid}/renderedmpr",tags=["wado","study"],
                                    responses={**ni_resp})
async def get_study_renderedmpr_api(study_uid: str, request: Request,
    ...
    Args:
        ...
        volumeinputreference (str | None): Please see
            https://www.dicomstandard.org/News-dir/ftsup/docs/sups/sup228.pdf for explanation
        match (str | None):
...
@wado_renderedmpr_router.get("/studies/{study_uid}/series/{series_uid}/renderedmpr",tags=["wado","series"],
                                    responses={**ni_resp})
async def get_series_renderedmpr_api(study_uid:str, series_uid:str, request: Request,
                                 volumeinputreference : str | None,
                                 match: str | None,
                                 renderingmethod : RenderingMethod | None = None,
                                 orientation: Orientation | None  =None,
...
@wado_renderedmpr_router.get("/studies/{study_uid}/series/{series_uid}/instances/{instance_uid}/renderedmpr",
                                tags=["wado","instance"],
                                responses={**ni_resp})
async def get_instance_renderedmpr_api(study_uid:str, series_uid:str, instance_uid:str, request: Request,
                                 volumeinputreference : str | None,
                                 match: str | None,
                                 renderingmethod : RenderingMethod | None = None,
                                 orientation: Orientation | None =None,
...
@wado_renderedmpr_router.get("/studies/{study_uid}/series/{series_uid}/instances/{instance_uid}/frames/{frames}/renderedmpr", # pylint: disable=line-too-long
                                tags=["wado","instance"],
                                responses={**ni_resp})# pylint: disable=line-too-long
async def get_frame_renderedmpr_api(study_uid:str, series_uid:str, instance_uid:str,
